...
export default function LoadingPage() {
  return (
    <main className="grid min-h-screen place-items-center px-4">
      <section className="w-full max-w-2xl rounded-lg border border-white/10 bg-black/45 p-8 text-center shadow-ember backdrop-blur">
        ...
        <p className="section-title">Campanha #{campaign.number}</p>
